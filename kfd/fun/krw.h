...
void do_kread(uint64_t kfd, uint64_t kaddr, void* uaddr, uint64_t size);
void do_kwrite(uint64_t kfd, void* uaddr, uint64_t kaddr, uint64_t size);
uint64_t get_kslide(uint64_t kfd);
uint64_t get_kernproc(uint64_t kfd);
uint8_t kread8(uint64_t kfd, uint64_t where);
uint32_t kread16(uint64_t kfd, uint64_t where);
uint32_t kread32(uint64_t kfd, uint64_t where);
uint64_t kread64(uint64_t kfd, uint64_t where);
void kwrite8(uint64_t kfd, uint64_t where, uint8_t what);
void kwrite16(uint64_t kfd, uint64_t where, uint16_t what);
